...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($name == "" || $email == "" || $category == "" || $title == "") {
    $error_message = "Please fill out these fields: Name, Email, Category and Title";
  }
...
?>
  ...
  <div class="section page">
    ...
    if(isset($_GET["status"]) && isset($_GET["status"]) == "thanks") { 
      echo "<p>Thank You! Thanks for your email, I&rsquo;ll check out your suggesstion shortly.</p>";
    } else {
